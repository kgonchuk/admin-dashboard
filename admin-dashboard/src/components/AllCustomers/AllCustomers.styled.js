...
export const CustomerCap=styled.caption`
 padding: 14px;
...
export const CustomerHeader = styled.thead`
...
export const CustomerHead = styled.th`
  padding: 14px;
  font-weight: 500;
  font-size: 12px;
  line-height: 1.17;
...
`;
export const CustomerHeadName = styled.th`
  padding: 14px 0;
  font-weight: 500;
  font-size: 12px;
  line-height: 1.17;
